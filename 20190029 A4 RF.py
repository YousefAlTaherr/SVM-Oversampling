...
train_predictions = model_forest.predict(X_train_scaled)
test_predictions = model_forest.predict(X_test_scaled)
...
print("ROC-AUC:", roc_auc_score(y_test, model_forest.predict_proba(X_test_scaled), multi_class='ovr'))

#with oversampling
smote = SMOTE()
X_train_smote, y_train_smote = smote.fit_resample(X_train_scaled, y_train)
model_forest.fit(X_train_smote, y_train_smote)
train_predictions_smote = model_forest.predict(X_train_smote)
test_predictions_smote = model_forest.predict(X_test_scaled)
